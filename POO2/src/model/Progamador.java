...
public class Progamador extends Profissional implements Bonificacao{
	
	private String cargaHoraria;
	private float salario;
	private int HorasEx = 0;
	private int extra = 0;
	...
	public void getBonificacao() {
		...
		setExtra(getHorasEx() * 15);
		System.out.println("Seu extra é de: R$" + getExtra());
